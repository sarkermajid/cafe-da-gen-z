                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" action="{{ route('admin.store.daily.market') }}" class="forms-sample"
                                id="myForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="transport_q"  class="form-control" placeholder="Quantity"
                                                id="transport_q">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="transport_p"  class="form-control" placeholder="Price"
                                                id="transport_p">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="rent_p"  class="form-control" placeholder="Price"
                                                id="rent_p">
                                        </div>
                                    </div>
                                </div>
